...
{{- if eq .Values.letsencrypt.mode "production" }}
{{- .Values.letsencrypt.issuerPrefix }}{{- include "wordpress.name" . }}-letsencrypt-production
{{- else }}
{{- .Values.letsencrypt.issuerPrefix }}{{- include "wordpress.name" . }}-letsencrypt-staging
{{- end }}
{{- end }}
